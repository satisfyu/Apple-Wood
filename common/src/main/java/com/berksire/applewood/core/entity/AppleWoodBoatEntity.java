package com.berksire.applewood.core.entity;
...
public class AppleWoodBoatEntity extends Boat {

    private static final EntityDataAccessor<Integer> WOOD_TYPE = SynchedEntityData.defineId(AppleWoodBoatEntity.class, EntityDataSerializers.INT);

    public AppleWoodBoatEntity(EntityType<? extends Boat> type, Level level) {
        super(type, level);
        this.blocksBuilding = true;
    }

    public AppleWoodBoatEntity(Level level, double x, double y, double z) {
        this(EntityTypeRegistry.APPLE_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
    ...
    public enum Type {
        APPLE("apple", ObjectRegistry.APPLE_BOAT, ObjectRegistry.APPLE_CHEST_BOAT);
        ...
        public ResourceLocation getTexture(boolean hasChest) {
            if (hasChest) {
                return new ResourceLocation(AppleWood.MODID, "textures/entity/chest_boat/" + name + ".png");
            }
            return new ResourceLocation(AppleWood.MODID, "textures/entity/boat/" + name + ".png");
        }
