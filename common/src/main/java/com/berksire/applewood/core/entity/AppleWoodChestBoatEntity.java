...
public class AppleWoodChestBoatEntity extends AppleWoodBoatEntity implements HasCustomInventoryScreen, ContainerEntity {
    ...
    public AppleWoodChestBoatEntity(EntityType<? extends Boat> entityType, Level level) {
        super(entityType, level);
    }

    public AppleWoodChestBoatEntity(Level level, double x, double y, double z) {
        this(EntityTypeRegistry.APPLE_CHEST_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
